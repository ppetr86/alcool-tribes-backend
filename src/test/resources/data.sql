...
INSERT INTO king.locations (id, x, y)
VALUES (1, 10, 10);

INSERT INTO king.resources (id, amount, generation, type, updated_at, fk_kingdom_id)
VALUES (1, 10, 10, 'FOOD', 111, 1);
INSERT INTO king.resources (id, amount, generation, type, updated_at, fk_kingdom_id)
VALUES (2, 11, 10, 'GOLD', 222, 1);

INSERT INTO king.troops (id, attack, defence, finished_at, hp, level, started_at, fk_kingdom_id)

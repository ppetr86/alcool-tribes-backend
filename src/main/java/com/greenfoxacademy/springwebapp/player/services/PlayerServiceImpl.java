...
public class PlayerServiceImpl implements PlayerService {
    ...
    public PlayerEntity copyProperties(KingdomEntity kingdom, PlayerRegisterRequestDTO dto,
                                       boolean verified) {
    ...
    @Override
    public Boolean existsPlayerByIdAndIsVerified(long id, boolean isVerified) {
        return playerRepo.existsByIdAndIsAccountVerified(id, isVerified);
    }
    ...
    @Override
    public List<Long> findAllByIsAccountVerified(boolean isAccountVerified) {
        return playerRepo.findAllByIsAccountVerified(isAccountVerified);
    }
    ...
    public PlayerEntity saveNewPlayer(PlayerRegisterRequestDTO dto) {
        ...
        kingdom.setKingdomName(
                dto.getKingdomname() == null ? dto.getUsername() + "'s kingdom" : dto.getKingdomname());
    ...
    @Override
    public boolean selectIsVerified(long id) {
        return playerRepo.selectIsVerified(id);
    }
    ...
    @Transactional
    @Override
    public void setAccountVerified(long id, boolean isAccountVerified) {
        playerRepo.setAccountVerified(id, isAccountVerified);
    }
    ...
    private boolean isWithinGrid(KingdomEntity thisKingdom, Integer distance,
                                 KingdomEntity otherKingdom) {

...
public class RegistrationController {
  ...
  public ResponseEntity<?> registerUser(@RequestBody @Valid PlayerRegistrationRequestDTO playerRegistrationRequestDTO, BindingResult bindingResult) {
    ...
    if (errorList.isEmpty()) {
      ...
      RegisterResponseDTO responsePlayerEntity = registrationService.savePlayer(playerRegistrationRequestDTO);
    ...
    } else if (playerRegistrationRequestDTO.getPassword() == null || playerRegistrationRequestDTO.getPassword().length() < 8){
